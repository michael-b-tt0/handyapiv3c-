...
public sealed class HandyApiV3ClientOptions
{
    ...
    public const string DefaultHostingApiBaseUrl = "https://www.handyfeeling.com/api/hosting/v2/";
    public const string DefaultApplicationApiKey = "wKTdv0fJNfBRdkf4-x5gUvtSuNPWzv-s";

    public string ApiBaseUrl { get; set; } = DefaultApiBaseUrl;
    public string HostingApiBaseUrl { get; set; } = DefaultHostingApiBaseUrl;
